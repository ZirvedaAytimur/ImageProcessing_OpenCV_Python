...
while 1:
    ...
    # determine the area where we will put our face
    # frame[y1:y2, x1:x2]
    roi = frame[50:250, 200:400]
    # set thickness to 0 so that it is not included in the mask process
    ...
    if len(contours) > 0:
        # try to find this as the biggest contour area will be the face
        c = findMaxContour(contours)

        # will find the smallest x and y accordingly
